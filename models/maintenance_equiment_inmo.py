...
class MaintenanceEquimentInmo(models.Model):
    ...
    url_carpeta_google_drive_category = fields.Char(string="URL Categoría GD",
                                                    related="category_id.url_carpeta_google_drive",readonly=True)
    ...
    def create(self, values):
        ...
        values['codigo_interno'] = self.env['ir.sequence'].next_by_code('sequence.maintenance.equipment1')
        ...
        return super(MaintenanceEquimentInmo, self).create(values)

    def copy(self, default=None):
        default = dict(default or {})
        default['name'] = self.name + ' (Copia)'
        return super(MaintenanceEquimentInmo, self).copy(default)
    ...
    def write(self, values):
        ...
        return super(MaintenanceEquimentInmo, self).write(values)
    ...
    @api.onchange('category_id', 'company_id', 'maintenance_team_id', 'technician_user_id', 'assign_date', 'id_seccion',
                  'location')
